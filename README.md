...
- General
  ...
  - Hybrid Dynamic Settings/AutoFPS-controlled Automation in Expert mode with MSFS 2024:
    ...
    - Works best when using FPS cap set in MSFS, with Max and Dynamic Settings Target Frame Rates in MSFS settings set to the native frame rate equivalent of the AutoFPS target FPS, and the FPS Cap automation mode in AutoFPS. 
